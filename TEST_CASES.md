...
| TC-AUTH-009 | Forgot password — user can request a password reset code via email | 1. Tap "Forgot Password" on login screen 2. Enter registered email address 3. Tap "Send Reset Link" | Email: juan@email.com (registered account) | 6-digit reset code sent to email, success message shown on screen, redirected to reset password screen | Success alert shown, user redirected to reset password screen where they enter the code | Pass |
| TC-AUTH-010 | Forgot password fails with unregistered email — system does not reveal whether email exists | 1. Tap "Forgot Password" 2. Enter an email not linked to any account 3. Tap "Send Reset Link" | Email: notregistered@email.com | Generic success message shown regardless of whether email exists, no account details leaked | Same generic success message shown for both registered and unregistered emails, no info leaked | Pass |
