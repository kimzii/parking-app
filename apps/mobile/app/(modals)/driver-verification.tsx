...
export default function DriverVerificationModal() {
  ...
  const checkVerificationStatus = async () => {
    try {
      ...
      if (!driverRole) {
        ...
        try {
          const driverProfile = await driversService.getProfile();
          const hasSubmittedDetails = Boolean(
            driverProfile?.licenseNumber && driverProfile?.licenseImageUrl,
          );
          setVerificationState(hasSubmittedDetails ? "pending" : "unsubmitted");
        } catch {
          // If profile doesn't exist yet, user has not submitted verification details.
          setVerificationState("unsubmitted");
        }
      } else {
        setVerificationState("unsubmitted");
  ...
  const handleApply = async () => {
    ...
    try {
      const uploadResult =
        await driversService.uploadLicenseImage(licenseImage);
      ...
      <View style={styles.centerContainer}>
        <View style={styles.statusCard}>
          ...
          <Text style={styles.statusText}>
            Your driver application has been submitted and is currently under
            review. We'll notify you once it's been processed.
          </Text>
    ...
    return (
      <View style={styles.centerContainer}>
        <View style={styles.statusCard}>
          ...
          <Text style={styles.statusText}>
            Your driver account has been verified. You can now book parking
            spaces.
          </Text>
      ...
      >
        {verificationState === "rejected" && (
          <View style={styles.rejectedBanner}>
            ...
            <Text style={styles.rejectedText}>
              Your previous application was rejected. Please resubmit with
              correct information.
            </Text>
          </View>
        )}
        ...
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.subtitle}>
            Upload your license to get verified
          </Text>
        </View>
